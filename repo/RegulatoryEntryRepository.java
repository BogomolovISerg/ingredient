...
public interface RegulatoryEntryRepository extends JpaRepository<RegulatoryEntry, Long> {
    ...
    @Query("""
        ...
        """)
    List<RegulatoryEntry> search(@Param("query") String query, Pageable pageable);
    ...
    @Query("""
        ...
        order by r.entryId asc
        """)
    List<RegulatoryEntry> searchByType(@Param("query") String query, @Param("type") RegulatoryListType type, Pageable pageable);
