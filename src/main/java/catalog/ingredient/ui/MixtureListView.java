...
public class MixtureListView extends VerticalLayout {
    ...
    public MixtureListView(IngredientService ingredientService) {
        ...
        grid.setDataProvider(DataProvider.fromCallbacks(
                query -> ingredientService.searchByKind(IngredientKind.MIXTURE, query.getOffset(), query.getLimit()).stream(),
                query -> ingredientService.countByKind(IngredientKind.MIXTURE)
        ));
